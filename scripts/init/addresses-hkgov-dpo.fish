...
./bin/saanseoi init:addresses:official:begin --target $saanseoi_init_target $continue_args
...
./bin/saanseoi init:addresses:official:complete --target $saanseoi_init_target
