...
export function printUsage() {
  ...
  saanseoi init [--continue] [--cacheArtefacts]
  ...
  saanseoi init:divisions:hkgov-landsd [--target local|preview|production] [--cacheArtefacts]
  saanseoi init:streets:hkgov-landsd [--cacheArtefacts]
