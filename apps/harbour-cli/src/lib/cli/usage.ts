...
export function printUsage() {
  ...
  saanseoi init:divisions [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:divisions:geographic [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:divisions:hkgov-censtatd-hma [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:stats:government [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:stats [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:divisions:hkgov-pland-pu [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:divisions:hkgov-pland-new-town [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:divisions:hkgov-landsd [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:places:overture [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:places [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  ...
  saanseoi init:streets:saanseoi [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
  saanseoi init:streets [--target local|preview|production] [--continue] [--no-cache-artefacts] [--skip-curation-checks]
