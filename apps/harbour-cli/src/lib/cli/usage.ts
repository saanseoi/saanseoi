...
export function printUsage() {
  ...
  saanseoi init:stats:official [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:streets:hkgov-landsd [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:addresses:official [--target local|preview|production] [--continue] [--no-cache-artefacts]
