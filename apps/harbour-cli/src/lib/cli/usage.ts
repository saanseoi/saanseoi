...
export function printUsage() {
  console.log(`  Usage:
  saanseoi sql:status --plan PATH --target local|preview|production
  saanseoi sql:resume --plan PATH --target local|preview|production [--mode remote|local|both]
  ...
  saanseoi init [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:local [--no-cache-artefacts]
  saanseoi init:production [--no-cache-artefacts]
  saanseoi init:divisions [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:divisions:geographic [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:divisions:hkgov-censtatd-hma [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:stats:government [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:divisions:hkgov-pland-pu [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:divisions:hkgov-pland-new-town [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:divisions:hkgov-landsd [--target local|preview|production] [--continue] [--no-cache-artefacts]
  saanseoi init:places:overture [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:streets:saanseoi [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:addresses:saanseoi [--target local|preview|production] [--continue] [--no-cache-artefacts]
