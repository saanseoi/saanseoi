...
export function printUsage() {
  ...
  saanseoi init:addresses [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:stats [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:places [--target local|preview|production] [--continue] [--no-cache-artefacts]
  ...
  saanseoi init:streets [--target local|preview|production] [--continue] [--no-cache-artefacts]
