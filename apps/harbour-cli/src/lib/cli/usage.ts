...
export function printUsage() {
  ...
  saanseoi update [--target local|preview|production] [--api-family all|addresses|divisions|places|stats|streets] [--dataset CODE[,CODE...]] [--download] [--force-download] [--no-upload] [--force|--check-now] [--yes]
