...
function printUsage() {
  ...
  bun run dataops -- hkgov-censtatd:statistics <source.zip> --target local|preview|production --dataset-code CODE --source-version PERIOD --release-notes-url URL --source-archive-key KEY --source-archive-sha256 SHA256 [--geography-only]
