/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 81623c57b8b83555311ac77f9144d260)
// Runtime types generated with workerd@1.20260825.1 2026-07-31 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	PUBLIC_KEY_LEASES: KVNamespace;
	BUCKET: R2Bucket;
	TILE_USAGE: AnalyticsEngineDataset;
	TILE_RATE_LIMIT: RateLimit;
	DIAGNOSTIC_ORIGINS: "https://maplibre.org,https://pmtiles.io,https://protomaps.github.io";
	DEV_ORIGINS: "http://localhost:5173,http://localhost:5174,http://localhost:5175,http://127.0.0.1:5173,http://127.0.0.1:5174,http://127.0.0.1:5175";
	CORE_ORIGIN_SUFFIXES: "*.hype.hk,*.type.hk,*.saanseoi.hk";
	HUB_ORIGINS: "https://saanseoi.hk,https://hype.hk,https://breadline.hk,https://hkghostsigns.com";
	...
	PUBLIC_KEY_LEASE_COORDINATOR: DurableObjectNamespace /* PublicKeyLeaseCoordinator from ss-atlas-api-prod */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIAGNOSTIC_ORIGINS" | "DEV_ORIGINS" | "CORE_ORIGIN_SUFFIXES" | "HUB_ORIGINS" | "PREVIEW_PREFIXES" | "EXTERNAL_ORIGINS" | "CACHE_CONTROL" | "PUBLIC_HOSTNAME" | "AUTH_MODE" | "ENVIRONMENT">> {}
}
