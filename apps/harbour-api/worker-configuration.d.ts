/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: f2dc61421a0d5c917fbd10078ba9dbb4)
// Runtime types generated with workerd@1.20260609.1 2026-05-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	R2_RAW: R2Bucket;
	DB: D1Database;
	DATASET_QUEUE: Queue;
	ATLAS_BASE_URL: "https://ss-atlas-preview.hypehk.workers.dev" | "https://ss-atlas-production.hypehk.workers.dev" | "http://localhost:8787";
	HARBOUR_BASE_URL: "https://ss-harbour-preview.hypehk.workers.dev" | "https://ss-harbour-production.hypehk.workers.dev" | "http://localhost:8788";
	R2_RAW_BUCKET_NAME: "ss-raw-preview" | "ss-raw-prod";
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		DB: D1Database;
		DATASET_QUEUE: Queue;
		ATLAS_BASE_URL: "https://ss-atlas-preview.hypehk.workers.dev";
		HARBOUR_BASE_URL: "https://ss-harbour-preview.hypehk.workers.dev";
	...
	interface ProductionEnv {
		...
		DB: D1Database;
		DATASET_QUEUE: Queue;
		ATLAS_BASE_URL: "https://ss-atlas-production.hypehk.workers.dev";
		HARBOUR_BASE_URL: "https://ss-harbour-production.hypehk.workers.dev";
		R2_RAW_BUCKET_NAME: "ss-raw-prod";
		HARBOUR_API_KEY: string;
		R2_ACCOUNT_ID: string;
		R2_RAW_ACCESS_KEY_ID: string;
		R2_RAW_SECRET_ACCESS_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATLAS_BASE_URL" | "HARBOUR_BASE_URL" | "R2_RAW_BUCKET_NAME" | "HARBOUR_API_KEY" | "R2_ACCOUNT_ID" | "R2_RAW_ACCESS_KEY_ID" | "R2_RAW_SECRET_ACCESS_KEY" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_ADMIN_ID">> {}
}
