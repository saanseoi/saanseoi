/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 7b161c6331730803c823c3b4e0cb9a3e)
// Runtime types generated with workerd@1.20260630.1 2026-06-04 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	JOB_QUEUE: Queue;
	CLOUDFLARE_ACCOUNT_ID: "a6eeace4b6d9f8e07ab307964e74d801";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "DATA_SHARD_ENV" | "HARBOUR_BASE_URL" | "HARBOUR_API_KEY" | "CLOUDFLARE_D1_TOKEN">> {}
}
