...
const openApiConfig = {
  ...
  tags: [
    {
      name: 'API Families',
      description: openApiText('openapi_api_families_description'),
      'x-displayName': openApiText('openapi_label_api_families'),
    },
    {
      name: 'API Releases',
      description: openApiText('openapi_api_releases_description'),
      'x-displayName': openApiText('openapi_label_api_releases'),
    },
    {
      name: 'API Fields',
      description: openApiText('openapi_api_fields_description'),
      'x-displayName': openApiText('openapi_label_api_fields'),
    },
    {
      name: 'API Endpoints',
      description: openApiText('openapi_api_endpoints_description'),
      'x-displayName': openApiText('openapi_label_api_endpoints'),
    },
    {
      name: 'Sources',
      description: openApiText('openapi_sources_description'),
      'x-displayName': openApiText('openapi_label_sources'),
    },
    {
      name: 'Source Versions',
      description: openApiText('openapi_source_versions_description'),
      'x-displayName': openApiText('openapi_label_source_versions'),
    },
    {
      name: 'Source Publishers',
      description: openApiText('openapi_source_publishers_description'),
      'x-displayName': openApiText('openapi_label_source_publishers'),
    },
    {
      name: 'Addresses',
      description: openApiText('openapi_addresses_description'),
      'x-displayName': openApiText('openapi_label_addresses'),
    },
    {
      name: 'Divisions',
      description: openApiText('openapi_divisions_description'),
      'x-displayName': openApiText('openapi_label_divisions'),
    },
    {
      name: 'Places',
      description: openApiText('openapi_places_description'),
      'x-displayName': openApiText('openapi_label_places'),
    },
    {
      name: 'Statistics',
    ...
    {
      name: 'Streets',
      description: openApiText('openapi_streets_description'),
      'x-displayName': openApiText('openapi_label_streets'),
    },
    {
      name: 'Source assets',
      description: openApiText('openapi_source_assets_description'),
      'x-displayName': openApiText('openapi_label_source_assets'),
    },
    {
      name: 'Map styles',
      description: openApiText('openapi_map_styles_description'),
      'x-displayName': openApiText('openapi_label_map_styles'),
    },
    {
      name: 'Meta',
      description: openApiText('openapi_meta_description'),
      'x-displayName': openApiText('openapi_label_meta'),
    },
  ],
  'x-tagGroups': [
    {
      name: openApiText('openapi_label_registry'),
      tags: [
        'API Families',
        'API Releases',
        'API Fields',
    ...
    { name: openApiText('openapi_label_addresses'), tags: ['Addresses'] },
    { name: openApiText('openapi_label_divisions'), tags: ['Divisions'] },
    { name: openApiText('openapi_label_places'), tags: ['Places'] },
    { name: openApiText('openapi_label_statistics'), tags: ['Statistics'] },
    { name: openApiText('openapi_label_streets'), tags: ['Streets'] },
    {
      name: openApiText('openapi_label_assets'),
      tags: ['Source assets'],
    },
    {
      name: openApiText('openapi_label_styles'),
      tags: ['Map styles'],
    },
    {
      name: openApiText('openapi_label_system'),
      tags: ['Meta'],
    },
  ],
}
