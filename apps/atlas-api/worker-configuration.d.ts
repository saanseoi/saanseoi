/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: b2583b44b388a794c1343ccd3c464872)
// Runtime types generated with workerd@1.20260815.1 2026-05-01 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	DB_HISTORY_HK_2025: D1Database;
	DB_HISTORY_HK_2026: D1Database;
	DB_SOURCE_HK_2025: D1Database;
	...
	PRODUCT_USAGE_DATASET: "ss-product-usage-preview" | "ss-product-usage-production" | "ss-product-usage-local";
	SUBSTACK_PUBLICATION: "saanseoi";
	USAGE_ROLLUP_DATASETS: "ss-api-usage-preview" | "ss-api-usage-production,ss-tile-usage-production" | "ss-api-usage-local";
	D1_PLACEMENT_PROBE_API_KEY: string;
	ANALYTICS_ENGINE_READ_TOKEN: string;
	SUBSTACK_SESSION_COOKIE: string;
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_ADMIN_ID: string;
	PUBLIC_KEY_LEASE_COORDINATOR: DurableObjectNamespace<import("./src/index").PublicKeyLeaseCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PublicKeyLeaseCoordinator";
	}
	interface PreviewEnv {
		...
		PRODUCT_USAGE_DATASET: "ss-product-usage-preview";
		SUBSTACK_PUBLICATION: "saanseoi";
		USAGE_ROLLUP_DATASETS: "ss-api-usage-preview";
		D1_PLACEMENT_PROBE_API_KEY: string;
		ANALYTICS_ENGINE_READ_TOKEN: string;
		SUBSTACK_SESSION_COOKIE: string;
		TELEGRAM_BOT_TOKEN: string;
	...
	interface ProductionEnv {
		...
		PRODUCT_USAGE_DATASET: "ss-product-usage-production";
		SUBSTACK_PUBLICATION: "saanseoi";
		USAGE_ROLLUP_DATASETS: "ss-api-usage-production,ss-tile-usage-production";
		D1_PLACEMENT_PROBE_API_KEY: string;
		ANALYTICS_ENGINE_READ_TOKEN: string;
		SUBSTACK_SESSION_COOKIE: string;
		TELEGRAM_BOT_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ATLAS_BASE_URL" | "ANALYTICS_ENGINE_ACCOUNT_ID" | "AUTH_MODE" | "ENVIRONMENT" | "HARBOUR_BASE_URL" | "PRODUCT_USAGE_DATASET" | "SUBSTACK_PUBLICATION" | "USAGE_ROLLUP_DATASETS" | "D1_PLACEMENT_PROBE_API_KEY" | "ANALYTICS_ENGINE_READ_TOKEN" | "SUBSTACK_SESSION_COOKIE" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_ADMIN_ID">> {}
}
