/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 356e2b2c00077209ec3444998149e9f1)
// Runtime types generated with workerd@1.20260820.1 2026-08-15 
interface __BaseEnv_CloudflareBindings {
	GITHUB_DISCUSSIONS_CATEGORY: "announcements";
	GITHUB_DISCUSSIONS_OWNER: "saanseoi";
	GITHUB_DISCUSSIONS_REPOSITORY: "saanseoi";
	...
	TELEGRAM_ANNOUNCEMENTS_CHAT_ID: string;
	TELEGRAM_BOT_TOKEN: string;
	TELEGRAM_LOG_CHAT_ID: string;
	DISCORD_BRIDGE: DurableObjectNamespace<import("./src/index").DiscordBridge>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DiscordBridge";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_DISCUSSIONS_CATEGORY" | "GITHUB_DISCUSSIONS_OWNER" | "GITHUB_DISCUSSIONS_REPOSITORY" | "DISCORD_ANNOUNCEMENTS_CHANNEL_ID" | "DISCORD_BOT_TOKEN" | "DISCORD_GUILD_ID" | "GITHUB_APP_ID" | "GITHUB_APP_INSTALLATION_ID" | "GITHUB_APP_PRIVATE_KEY_BASE64" | "TELEGRAM_ANNOUNCEMENTS_CHAT_ID" | "TELEGRAM_BOT_TOKEN" | "TELEGRAM_LOG_CHAT_ID">> {}
}
