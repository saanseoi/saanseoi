...
friction-heavy, attention-seeking patterns of modern SaaS in favor of an editorial,
...
The visual style is **Modernist Editorial**. It prioritizes high-contrast legibility,
purposeful whitespace, and a structural grid inspired by architectural blueprints. By
utilizing an eggshell foundation rather than pure white, the system achieves a
...
- **Jade Green:** The secondary color, representing the intersection of nature and urban
  life. Used for success states, active navigational elements, and growth-related data.
- **Terracotta:** The tertiary color, inspired by historic masonry. Used for highlights,
  calls to action, and points of tension or urgency.
...
The layout follows a **Fixed-Column Modernist Grid**. This system prioritizes vertical
...
element relationship. The goal is to maximize whitespace to allow the eggshell
background to "breathe."

## Elevation & Depth

This design system avoids traditional drop shadows and neomorphic blurs to maintain its
"Public Institution" feel. Instead, it utilizes **Tonal Layering and Ink Borders**.
...
- **Cards:** No shadows. Use a subtle 1px border (Ink at 15% opacity) and maximize
  internal padding (at least 24px) to ensure content never feels cramped.
- **Data Visuals:** Hong Kong-specific data should be visualized using geometric,
  clean-line charts in Jade and Ink, avoiding overly-vibrant "dashboard" colors.
