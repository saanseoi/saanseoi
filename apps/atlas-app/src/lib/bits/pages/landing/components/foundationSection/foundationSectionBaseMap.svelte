...
<div
  class={cn(
    'relative h-[max(clamp(38rem,56vw,47rem),calc(100svh-var(--landing-header-height)))] min-h-[clamp(38rem,56vw,47rem)] overflow-hidden bg-[#feffeb] [--foundation-map-background:#feffeb] [--landing-header-height:4.5rem] dark:bg-surface dark:[--foundation-map-background:var(--surface)] max-[785px]:h-auto max-[785px]:min-h-0',
    className,
  )}
>
  <svg
