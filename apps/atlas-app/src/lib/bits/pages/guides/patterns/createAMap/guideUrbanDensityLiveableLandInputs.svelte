...
<div class="space-y-5">
  ...
  >
    ...
    >
      <p
        class="font-display text-title-lg font-bold leading-5 tracking-tight text-secondary"
      >
        {@html resourceTitle}
      </p>
      <p class="mt-2">
      ...
      <div class="mt-5 flex flex-wrap justify-end gap-3">
        <a
          ...
          href="#project-liveable-land-result"
        >
          {resourceDownloadJsonResult}
        </a>
        <a
  ...
  <div class="relative lg:-mr-96 lg:w-[calc(100%+24rem)]">
    ...
    <aside
      class="mt-6 [&_code]:rounded-sm [&_code]:border [&_code]:border-border-card [&_code]:bg-surface-container-low [&_code]:px-1 [&_code]:font-mono [&_code]:text-[0.85em] lg:absolute lg:top-0 lg:right-0 lg:left-[calc(48rem+1.5rem)] lg:mt-0"
    >
