...
const setupZ14TileFetcherComments = [
  ...
  { line: 3, text: m.guide_data_urban_density_setup_comment_jsts() },
  { line: 9, text: m.guide_data_urban_density_liveable_area_comment_import() },
  { line: 12, text: m.guide_data_urban_density_collect_comment_zoom() },
  { line: 13, text: m.guide_data_urban_density_collect_comment_longitude() },
  { line: 14, text: m.guide_data_urban_density_collect_comment_latitude() },
  { line: 18, text: m.guide_data_urban_density_setup_comment_tile_edges() },
  { line: 23, text: m.guide_data_urban_density_setup_comment_tile_rectangle() },
  { line: 28, text: m.guide_data_urban_density_collect_comment_overlap() },
  { line: 31, text: m.guide_data_urban_density_collect_comment_envelope() },
  { line: 43, text: m.guide_data_urban_density_setup_comment_tile_outline_feedback() },
  { line: 47, text: m.guide_data_urban_density_setup_comment_tile_outline() },
  { line: 51, text: m.guide_data_urban_density_setup_comment_tile_outline_source() },
  { line: 54, text: m.guide_data_urban_density_setup_comment_show_tile_outline() },
  { line: 58, text: m.guide_data_urban_density_setup_comment_focus_district() },
  { line: 63, text: m.guide_data_urban_density_setup_comment_non_liveable_kinds() },
  { line: 64, text: m.guide_data_urban_density_setup_comment_repair_polygons() },
  { line: 69, text: m.guide_data_urban_density_setup_comment_repair_overlay() },
  { line: 89, text: m.guide_data_urban_density_collect_comment_tile_url() },
  { line: 91, text: m.guide_data_urban_density_collect_comment_tile_url_for() },
  { line: 96, text: m.guide_data_urban_density_setup_comment_cache() },
  { line: 97, text: m.guide_data_urban_density_setup_comment_tile_decoder() },
  { line: 103, text: m.guide_data_urban_density_collect_comment_decode() },
  { line: 107, text: m.guide_data_urban_density_setup_comment_features() },
  { line: 109, text: m.guide_data_urban_density_collect_comment_filter() },
  { line: 111, text: m.guide_data_urban_density_setup_comment_geojson() },
  { line: 112, text: m.guide_data_urban_density_setup_comment_areas() },
  { line: 123, text: m.guide_data_urban_density_collect_comment_district_tiles() },
  { line: 133, text: m.guide_data_urban_density_collect_comment_progress() },
  { line: 151, text: m.guide_data_urban_density_setup_comment_progress() },
  { line: 162, text: m.guide_data_urban_density_collect_comment_progress_wrapper() },
  { line: 166, text: m.guide_data_urban_density_setup_comment_district_progress() },
]
...
const liveableAreaComments = [
  ...
  { line: 55, text: m.guide_data_urban_density_saved_result_keep() },
  { line: 56, text: m.guide_data_urban_density_liveable_area_comment_json() },
  { line: 57, text: m.guide_data_urban_density_liveable_area_comment_dialog() },
  {
    line: 58,
    text: m.guide_data_urban_density_liveable_area_comment_dialog_style(),
  },
  { line: 59, text: m.guide_data_urban_density_liveable_area_comment_result_title() },
  {
    line: 60,
  ...
  { line: 62, text: m.guide_data_urban_density_liveable_area_comment_download() },
  { line: 63, text: m.guide_data_urban_density_liveable_area_comment_download_label() },
  {
    line: 64,
    text: m.guide_data_urban_density_liveable_area_comment_download_style(),
  },
  { line: 65, text: m.guide_data_urban_density_liveable_area_comment_download_url() },
  { line: 66, text: m.guide_data_urban_density_liveable_area_comment_download_name() },
  {
    line: 67,
    text: m.guide_data_urban_density_liveable_area_comment_dialog_contents(),
  },
  { line: 68, text: m.guide_data_urban_density_liveable_area_comment_attach_dialog() },
  { line: 69, text: m.guide_data_urban_density_liveable_area_comment_show_dialog() },
]
