...
const setupZ14TileFetcherComments = [
  ...
  { line: 48, text: m.guide_data_urban_density_setup_comment_show_tile_outline() },
  { line: 52, text: m.guide_data_urban_density_setup_comment_focus_district() },
  ...
  { line: 62, text: m.guide_data_urban_density_collect_comment_tile_url() },
  { line: 64, text: m.guide_data_urban_density_collect_comment_tile_url_for() },
  { line: 69, text: m.guide_data_urban_density_setup_comment_cache() },
  { line: 70, text: m.guide_data_urban_density_setup_comment_tile_decoder() },
  { line: 76, text: m.guide_data_urban_density_collect_comment_decode() },
  { line: 80, text: m.guide_data_urban_density_setup_comment_features() },
  { line: 82, text: m.guide_data_urban_density_collect_comment_filter() },
  { line: 84, text: m.guide_data_urban_density_setup_comment_geojson() },
  { line: 85, text: m.guide_data_urban_density_setup_comment_areas() },
  { line: 96, text: m.guide_data_urban_density_collect_comment_district_tiles() },
  { line: 106, text: m.guide_data_urban_density_collect_comment_progress() },
  { line: 124, text: m.guide_data_urban_density_setup_comment_progress() },
  { line: 135, text: m.guide_data_urban_density_collect_comment_progress_wrapper() },
  { line: 139, text: m.guide_data_urban_density_setup_comment_district_progress() },
]
