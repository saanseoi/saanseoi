...
const setupZ14TileFetcherComments = [
  ...
  { line: 9, text: m.guide_data_urban_density_collect_comment_zoom() },
  ...
  { line: 15, text: m.guide_data_urban_density_setup_comment_tile_edges() },
  { line: 20, text: m.guide_data_urban_density_setup_comment_tile_rectangle() },
  { line: 24, text: m.guide_data_urban_density_collect_comment_overlap() },
  { line: 27, text: m.guide_data_urban_density_collect_comment_envelope() },
  { line: 39, text: m.guide_data_urban_density_setup_comment_tile_outline_feedback() },
  { line: 43, text: m.guide_data_urban_density_setup_comment_tile_outline() },
  { line: 47, text: m.guide_data_urban_density_setup_comment_tile_outline_source() },
  { line: 48, text: m.guide_data_urban_density_setup_comment_show_tile_outline() },
  { line: 52, text: m.guide_data_urban_density_setup_comment_non_liveable_kinds() },
  { line: 53, text: m.guide_data_urban_density_collect_comment_tile_url() },
  { line: 55, text: m.guide_data_urban_density_collect_comment_tile_url_for() },
  { line: 60, text: m.guide_data_urban_density_setup_comment_cache() },
  { line: 61, text: m.guide_data_urban_density_setup_comment_tile_decoder() },
  { line: 69, text: m.guide_data_urban_density_collect_comment_decode() },
  { line: 70, text: m.guide_data_urban_density_setup_comment_features() },
  { line: 73, text: m.guide_data_urban_density_collect_comment_filter() },
  { line: 75, text: m.guide_data_urban_density_setup_comment_geojson() },
  { line: 76, text: m.guide_data_urban_density_setup_comment_areas() },
  { line: 87, text: m.guide_data_urban_density_collect_comment_district_tiles() },
  { line: 92, text: m.guide_data_urban_density_collect_comment_progress() },
  { line: 98, text: m.guide_data_urban_density_setup_comment_progress() },
  { line: 106, text: m.guide_data_urban_density_collect_comment_progress_wrapper() },
  { line: 108, text: m.guide_data_urban_density_setup_comment_district_progress() },
]
