...
export const urbanDensitySetupZ14TileFetcherCode = [
  ...
  '      : []',
  '// Run this only after Turf has created a complete District’s excluded or liveable shape.',
  ...
  '  let polygonal = 0',
  '  try {',
  '    // First resolve crossing edges and collapsed rings in GEOS’s geometry format.',
...
export const urbanDensityLiveableAreaCode = [
  ...
  '    await pauseForAir()',
  '  }',
  '  // Make the completed exclusion valid without merging its separate land pieces.',
  ...
  '  // Make the liveable result valid too, preserving every separate land piece.',
  ...
  '  const liveable = await repairOverlay(remainingLand)',
