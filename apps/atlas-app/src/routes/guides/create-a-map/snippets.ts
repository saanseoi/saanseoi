...
export const urbanDensityLiveableAreaCode = [
  ...
  "resultDialog.style.cssText = 'margin: auto; width: min(calc(100vw - 2rem), 48rem); border: 1px solid rgba(255, 255, 255, 0.2); background: #171c25; padding: 1.25rem; box-shadow: 0 25px 50px -12px rgb(0 0 0 / 0.25)'",
  "const download = document.createElement('a')",
  "download.textContent = 'Download land-analysis.json'",
  "download.style.cssText = 'display: block; border: 1px solid #79e7d1; background: #43c6ad; padding: 0.625rem 1rem; color: #10151a; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 0.75rem; font-weight: 700; line-height: 1.25rem; text-align: center; text-decoration: none'",
  "download.href = URL.createObjectURL(new Blob([resultJson], { type: 'application/json' }))",
  "download.download = 'land-analysis.json'",
  'resultDialog.append(download)',
