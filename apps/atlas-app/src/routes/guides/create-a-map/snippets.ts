...
export const urbanDensityCalculationCode = [
  ...
  '    properties: { districtCode: code, districtName: districtNameByCode[code] ?? code, area: area.meta.name, population: Number(populationByDistrict[code]), landAreaSqKm: Number(landAreaByDistrict[code]) },',
  '    geometry,',
  '  }',
  '})',
  '',
...
export const urbanDensitySetupZ14TileFetcherCode = [
  ...
  "progressPanel.style.cssText = 'position: fixed; left: 50%; bottom: 1rem; z-index: 1; width: min(calc(100% - 2rem), 24rem); transform: translateX(-50%); border: 1px solid rgba(255, 255, 255, 0.2); background: rgba(16, 21, 26, 0.95); padding: 1rem 1.25rem; color: white; text-align: center; font-family: system-ui, sans-serif'",
  "const progressPhase = document.createElement('p')",
  "progressPhase.style.cssText = 'margin: 0; color: rgba(255, 255, 255, 0.7); font-family: ui-monospace, monospace; font-size: 0.68rem; font-weight: 700; letter-spacing: 0.12em'",
  "const progressDistrict = document.createElement('h2')",
  "progressDistrict.style.cssText = 'margin: 0.375rem 0 0; color: #79e7d1; font-family: ui-monospace, monospace; font-size: 1.875rem; font-weight: 700; letter-spacing: -0.025em; line-height: 1'",
  "const progressCount = document.createElement('p')",
  "progressCount.style.cssText = 'margin: 0.75rem 0 0; color: rgba(255, 255, 255, 0.85); font-family: ui-monospace, monospace; font-size: 1rem; font-weight: 600; font-variant-numeric: tabular-nums'",
  "const districtCounts = document.createElement('dl')",
  "districtCounts.style.cssText = 'display: none; grid-template-columns: 1fr auto 1fr; align-items: end; gap: 0.75rem; margin: 0.75rem 0 0; font-family: ui-monospace, monospace; font-variant-numeric: tabular-nums'",
  'districtCounts.innerHTML = \'<div><dt style="color: rgba(255, 255, 255, 0.55); font-size: 0.68rem; font-weight: 700; letter-spacing: 0.12em">PARTS</dt><dd data-parts style="margin: 0.125rem 0 0; color: rgba(255, 255, 255, 0.85); font-size: 1rem; font-weight: 600"></dd></div><div aria-hidden="true" style="padding-bottom: 0.125rem; color: rgba(255, 255, 255, 0.45); font-size: 0.75rem; font-weight: 700">for</div><div><dt style="color: rgba(255, 255, 255, 0.55); font-size: 0.68rem; font-weight: 700; letter-spacing: 0.12em">DISTRICTS</dt><dd data-districts style="margin: 0.125rem 0 0; color: rgba(255, 255, 255, 0.85); font-size: 1rem; font-weight: 600"></dd></div>\'',
  "const progress = document.createElement('progress')",
  "progress.style.cssText = 'display: block; width: 100%; height: 0.5rem; margin-top: 1rem; accent-color: #43c6ad'",
  ...
  "  progressCount.style.display = ''",
  "  districtCounts.style.display = 'none'",
  ...
  "  districtCounts.style.display = 'grid'",
...
export const urbanDensityLiveableAreaCode = [
  ...
  "resultDialog.style.cssText = 'margin: auto; width: min(calc(100vw - 2rem), 32.5rem); border: 1px solid rgba(255, 255, 255, 0.2); background: #171c25; padding: 1.25rem; box-shadow: 0 25px 50px -12px rgb(0 0 0 / 0.25)'",
  "const resultTitle = document.createElement('h2')",
  "resultTitle.textContent = 'Calculation complete'",
  "resultTitle.style.cssText = 'margin: 0 0 1rem; color: #79e7d1; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 0.875rem; font-weight: 700; letter-spacing: 0.08em; line-height: 1.25rem; text-transform: uppercase'",
  "const download = document.createElement('a')",
  "download.textContent = 'Download land-analysis.json'",
  "download.style.cssText = 'display: block; border: 1px solid #79e7d1; background: #43c6ad; padding: 0.625rem 1rem; color: #10151a; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace; font-size: 1rem; font-weight: 700; line-height: 1.5rem; text-align: center; text-decoration: none'",
...
export const urbanDensityLiveableMetricsCode = [
  ...
  'const districtAreaByDistrict = new Map(',
  '  districts.map(district => [district.properties.districtCode, area(district) / 1_000_000]),',
  ')',
  '',
  ...
  '  const districtAreaSqKm = districtAreaByDistrict.get(districtCode) ?? 0',
  '  const excludedAreaSqKm = districtAreaSqKm - area(district) / 1_000_000',
