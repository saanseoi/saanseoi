...
export const urbanDensitySetupZ14TileFetcherCode = [
  ...
  '  setProgressCounts(completedTiles, totalAnalysisTiles, 0, undefined, districts.indexOf(tile.district))',
  ...
  '  setProgressCounts(completedTiles, totalAnalysisTiles, completedParts, totalParts, completed)',
