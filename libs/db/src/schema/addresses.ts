...
export const address2dVersions = sqliteTable(
  ...
  (table) => ({
    ...
    currentLookupIdx: index("address2dVersions_current_lookup_idx").on(table.id, table.isCurrent),
    validityIdx: index("address2dVersions_validity_idx").on(table.validFromMonth, table.validToMonth),
...
export const address3dVersions = sqliteTable(
  ...
  (table) => ({
    ...
    currentLookupIdx: index("address3dVersions_current_lookup_idx").on(table.id, table.isCurrent),
    validityIdx: index("address3dVersions_validity_idx").on(table.validFromMonth, table.validToMonth),
