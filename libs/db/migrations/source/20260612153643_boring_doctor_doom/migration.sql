...
CREATE TABLE `sourceOvertureDivisions` (
	...
	`geometryJson` text,
	`bboxJson` text,
	`hierarchiesJson` text,
	`cartographyJson` text,
	`sourcesJson` text,
	`rawPropertiesJson` text,
...
CREATE TABLE `sourceOverturePlaces` (
	...
	`taxonomyHierarchyJson` text,
	`taxonomyAlternatesJson` text,
	`brandWikidata` text,
	`websitesJson` text,
	`socialsJson` text,
	`emailsJson` text,
