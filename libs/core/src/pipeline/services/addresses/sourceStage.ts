import { sourceLocatorFromReferences } from '../sources/sourcePayload'
...
import { type PipelineArtefactBucket, readJsonArtefact } from '../storage/artefacts'
import {
...
type SourceReferences = Array<{ dataset: string; [key: string]: unknown }>
