...
apiReleaseSet: "data-hk-divisions-2026-02-18.0"
regionCode: "hk"
...
- <orange>Upstream</orange> Overture refreshed OSM data and added `admin_level`.
  SaanSeoi retains it as `overture.admin_level` compatibility information when
  available; before our launch, we backfilled the value to every Divisions release
