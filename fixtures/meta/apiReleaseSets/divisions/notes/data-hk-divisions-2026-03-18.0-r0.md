...
apiReleaseSet: "data-hk-divisions-2026-03-18.0"
regionCode: "hk"
...
- <orange>Upstream</orange> Overture made minor incremental changes to the data.
...
- <orange>上游</orange> Overture 對資料作出輕微、逐步的更新。
...
- <orange>上游</orange> Overture 对数据作出轻微、渐进式的更新。
