...
apiReleaseSet: "data-hk-divisions-2026-07-22.0"
...
- <orange>Upstream</orange> Overture used an OSM cut-off date of
  <black>2026-07-14</black>, made minor incremental data updates, and added optional
  `provider`, `resource`, and `version` provenance fields to `sources`. See the linked
  source release for their definitions and upstream migration detail.
...
- <orange>上游</orange> Overture 的 OSM 截止日期為
  <black>2026-07-14</black>，並作出輕微、逐步的資料更新，在 `sources` 新增可選的
  `provider`、`resource` 及 `version`
  來源追溯欄位。請參閱連結的來源發布，了解其定義及上游遷移詳情。
...
- <orange>上游</orange> Overture 的 OSM 截止日期为
  <black>2026-07-14</black>，并作出轻微、渐进式的数据更新，在 `sources` 新增可选的
  `provider`、`resource` 及 `version`
  来源追溯字段。请参阅链接的来源发布，了解其定义及上游迁移详情。
