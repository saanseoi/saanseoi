...
apiReleaseSet: "data-hk-places-2026-04-15.0"
revision: "0"
regionCode: "hk"
...
- <orange>Upstream</orange> Rolled back unexpected March confidence-normalisation
  changes in Meta-sourced Place data.
- <orange>Upstream</orange> Applied third-party signals to update confidence scores.
...
- The Place collection is anchored to the Overture Place source release for this cohort.
  ...
  <black>/places/v0.1/sources?sourceRelease=dr-hk-overture-place-2026-04-15.0</black>.
...
- <orange>Upstream</orange>
  回復 Meta 來源 Place 資料中 3 月意外的 confidence-normalisation 變更。
- <orange>Upstream</orange> 套用第三方 signal，更新約一千萬個 Place 的 confidence 評分。
...
- Confidence 變更是上游來源變更，不是 Places API 合約變更，亦非對 Place 的獨立核實。
...
- <orange>Upstream</orange>
  回退 Meta 来源 Place 数据中 3 月意外的 confidence-normalisation 变更。
- <orange>Upstream</orange> 应用第三方 signal，更新约一千万个 Place 的 confidence 评分。
...
- Confidence 变更是上游源变更，不是 Places API 合约变更，也非对 Place 的独立核实。
