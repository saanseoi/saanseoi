...
release: "dr-hk-overture-place-2026-05-20.0"
regionCode: "hk"
source: "overture"
sourceVersion: "2026-05-20.0"
releaseVersion: "2026-05-20.0"
sourceSchemaVersion: "1.17.0"
type: "place"
cohortKey: "2026-05-20.0"
releaseNotesUrl: "https://docs.overturemaps.org/blog/2026/05/20/release-notes/#places"
---
...
- <orange>Upstream</orange> Changed the default value of <black>operating_status</black>
  from "open" to null
- <orange>Upstream</orange> Updated the default confidence values of existing providers
...
- <orange>上游</orange>
  新增 BrightQuery 為 POI 資料提供者，帶來約 250,000 個新的美國地點，以及為現有要素新增一百萬個 signals
- <orange>上游</orange> 將 <black>operating_status</black> 的預設值由「open」改為 null
- <orange>上游</orange> 更新現有提供者的預設 confidence 值
...
- <orange>上游</orange>
  新增 BrightQuery 作为 POI 数据提供商，带来约 250,000 个新的美国地点，以及为现有要素新增一百万个 signals
- <orange>上游</orange> 将 <black>operating_status</black> 的默认值从“open”改为 null
- <orange>上游</orange> 更新现有提供商的默认 confidence 值
