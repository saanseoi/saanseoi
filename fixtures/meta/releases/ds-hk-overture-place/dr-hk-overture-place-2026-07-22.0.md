...
release: "dr-hk-overture-place-2026-07-22.0"
regionCode: "hk"
source: "overture"
...
releaseNotesUrl: "https://docs.overturemaps.org/blog/2026/07/22/release-notes/#places"
---
...
- <orange>上游</orange> 為 BrightQuery 引入三個先前被過濾的頂層分類：
  <black>arts_and_entertainment</black>、<black>lodging</black> 及
  <black>cultural_and_historic</black>
- <orange>上游</orange> 改進配對，提高已配對地點數量並減少重複記錄
...
- <orange>上游</orange> 为 BrightQuery 引入三个此前被过滤的顶层分类：
  <black>arts_and_entertainment</black>、<black>lodging</black> 和
  <black>cultural_and_historic</black>
- <orange>上游</orange> 改进匹配，提高已匹配地点数量并减少重复记录
