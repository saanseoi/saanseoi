---
createdAt: "2026-07-14T05:23:06.178Z"
updatedAt: "2026-07-22T00:00:00.000Z"
dataset: "ds-hk-overture-place"
release: "dr-hk-overture-place-2026-04-15.0"
regionCode: "hk"
source: "overture"
sourceVersion: "2026-04-15.0"
releaseVersion: "2026-04-15.0"
sourceSchemaVersion: "1.16.0"
type: "place"
cohortKey: "2026-04-15.0"
releaseNotesUrl: "https://docs.overturemaps.org/blog/2026/04/15/release-notes/#places"
---
...
- <orange>Upstream</orange> Rolled back unexpected changes to confidence-score
  normalisation in Meta-sourced place data from the March release
- <orange>Upstream</orange> Increased the number of signals applied to Places; around 10
  million places now receive updated confidence scores from third-party signal data
...
- <orange>上游</orange>
  撤回三月版本對 Meta 來源地點資料的 confidence 分數正規化所作的意外變更
- <orange>上游</orange>
  增加套用於 Places 的 signals 數量；現時約一千萬個地點會根據第三方 signal 資料獲得更新的 confidence 分數
...
- <orange>上游</orange>
  撤回三月版本对 Meta 来源地点数据的 confidence 分数规范化所作的意外变更
- <orange>上游</orange>
  增加应用于 Places 的 signals 数量；目前约一千万个地点会根据第三方 signal 数据获得更新的 confidence 分数
