...
release: "dr-hk-overture-place-2026-06-17.0"
regionCode: "hk"
source: "overture"
...
releaseNotesUrl: "https://docs.overturemaps.org/blog/2026/06/17/release-notes/#places"
---
...
- <orange>Upstream</orange> Filtered out places whose feature country code is outside
  that country's boundary, most visibly reducing features in the ocean
...
- <orange>上游</orange>
  剔除位於其要素國家代碼所指國家邊界以外的地點；最明顯的影響是海洋中的要素減少
...
- <orange>上游</orange>
  剔除位于其要素国家代码所指国家边界以外的地点；最明显的影响是海洋中的要素减少
