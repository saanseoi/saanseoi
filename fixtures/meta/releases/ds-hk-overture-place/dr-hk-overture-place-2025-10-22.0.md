...
release: "dr-hk-overture-place-2025-10-22.0"
regionCode: "hk"
source: "overture"
sourceVersion: "2025-10-22.0"
releaseVersion: "2025-10-22.0"
sourceSchemaVersion: "1.13.0"
type: "place"
cohortKey: "2025-10-22.0"
releaseNotesUrl: "https://docs.overturemaps.org/blog/2025/10/22/release-notes/#places"
---
...
- <orange>Upstream</orange> Added a new <black>basic_category</black> property to the
  Places schema and populated it with data
...
- `basic_category` - exposed as <black>place.basicCategory</black>. This source version
  adds the field and populates it with data.
- `categories.primary` - used as <black>place.taxonomy.primary</black> because this
  source version does not yet provide a <black>taxonomy</black> field.
...
- <orange>上游</orange> 在 Places schema 新增 <black>basic_category</black>
  欄位，並填入資料
...
- `basic_category` - 在 API 回應中公開為
  <black>place.basicCategory</black>；此來源版本新增此欄位並填入資料。
- `categories.primary` - 由於此來源版本尚未提供 <black>taxonomy</black> 欄位，用作
  <black>place.taxonomy.primary</black>。
...
- `basic_category` - 在 API 响应中公开为
  <black>place.basicCategory</black>；此源版本新增此字段并填入数据。
- `categories.primary` - 由于此源版本尚未提供 <black>taxonomy</black> 字段，用作
  <black>place.taxonomy.primary</black>。
