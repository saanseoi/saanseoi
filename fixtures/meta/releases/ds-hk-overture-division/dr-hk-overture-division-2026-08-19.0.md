...
release: "dr-hk-overture-division-2026-08-19.0"
regionCode: "hk"
source: "overture"
sourceVersion: "2026-08-19.0"
releaseVersion: "2026-08-19.0"
sourceSchemaVersion: "1.18.0"
type: "division"
cohortKey: "2026-08-19.0"
releaseNotesUrl: "https://docs.overturemaps.org/blog/2026/08/19/release-notes/#divisions"
---
...
- <orange>Upstream</orange> Geometry refinements were the top source of updates compared
  to the July release.
...
- <orange>上游</orange> Overture 資料版本：<black>2026-08-19.0</black>；schema版本維持
  <black>v1.18.0</black>。
- <orange>上游</orange> division 數量：七月 <black>4,655,003</black>，八月
  <black>4,658,700</black>（<black>+0.08%</black>）。
- <orange>上游</orange> 與七月版本相比，幾何修訂是更新的主要來源。
- <orange>上游</orange> 將越南部分 microhoods 重新分類為 neighbourhoods。
...
- <orange>上游</orange> Overture 数据版本：<black>2026-08-19.0</black>；schema版本维持
  <black>v1.18.0</black>。
- <orange>上游</orange> division 数量：七月 <black>4,655,003</black>，八月
  <black>4,658,700</black>（<black>+0.08%</black>）。
- <orange>上游</orange> 与七月版本相比，几何细化是更新的主要来源。
- <orange>上游</orange> 将越南部分 microhoods 重新分类为 neighbourhoods。
