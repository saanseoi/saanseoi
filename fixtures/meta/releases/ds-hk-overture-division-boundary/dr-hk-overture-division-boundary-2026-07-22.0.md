...
release: "dr-hk-overture-division-boundary-2026-07-22.0"
regionCode: "hk"
source: "overture"
sourceVersion: "2026-07-22.0"
releaseVersion: "2026-07-22.0"
sourceSchemaVersion: "1.18.0"
type: "divisionBoundary"
cohortKey: "2026-07-22.0"
releaseNotesUrl: "https://docs.overturemaps.org/blog/2026/07/22/release-notes/#divisions"
---
...
- <orange>Upstream</orange> Added optional provider, resource, and version fields to the
  sources object for data provenance tracking (first step toward deprecating dataset,
  targeted for a breaking change in September).
...
- <orange>Upstream</orange> Fixed schema to allow `is_land` and `is_territorial` to both
  be true simultaneously (previously mutually exclusive).
  ([GitHub issue #546](https://github.com/OvertureMaps/schema/pull/546))
